...
function Card({username="User"}) {
    return(
        <div className="bg-neutral-primary-soft block max-w-sm p-6 border border-default rounded-base shadow-xs">
          <a href="#">
              <img className="rounded-base" src="https://flowbite.com/docs/images/blog/image-1.jpg" alt="" />
          </a>
          <a href="#">
              <h5 className="mt-6 mb-2 text-2xl font-semibold tracking-tight text-heading">{username}</h5>
          </a>
